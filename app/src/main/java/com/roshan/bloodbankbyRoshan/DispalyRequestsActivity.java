package com.roshan.bloodbankbyRoshan;
...
import com.roshan.bloodbankbyRoshan.adapters.UserAdapter;
...
public class DispalyRequestsActivity extends AppCompatActivity {
    ...
    private void updateList(String toString) {
        temp.clear();
        for( User v : requests){
            if(v.getDistrict().toUpperCase().contains(toString.toUpperCase())||toString.equalsIgnoreCase("ALL")) {
